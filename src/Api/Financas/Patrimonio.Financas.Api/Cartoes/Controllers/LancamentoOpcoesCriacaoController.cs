...
/// <summary>
/// Disponibiliza as opções de referência necessárias para a criação de um lançamento.
/// </summary>
[ApiController]
[Route("api/v1/financas/lancamentos/opcoes-criacao")]
public sealed class LancamentoOpcoesCriacaoController(
    ILancamentoOpcoesCriacaoService opcoesCriacaoService) : ControllerBase
{
    /// <summary>
