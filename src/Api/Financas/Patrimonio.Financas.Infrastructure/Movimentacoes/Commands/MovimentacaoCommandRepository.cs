...
/// </summary>
internal sealed class MovimentacaoCommandRepository(FinancasDbContext context, DatabaseExceptionTranslator translator)
    : CommandRepository<Movimentacao>(context, translator), IMovimentacaoCommandRepository
{
}
