...
/// </summary>
internal sealed class CategoriaCommandRepository(FinancasDbContext context, DatabaseExceptionTranslator translator)
    : CommandRepository<Categoria>(context, translator), ICategoriaCommandRepository
{
}
